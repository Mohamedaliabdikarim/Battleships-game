...
def play_battleship():
    while True:
        ...
        print("Select a number between 0-99.")
        print("")
        print("The vertical axis signifies digits 0-9, and the horizontal axis represents the\nsecond digit.")
        print("For instance, entering 50 implies that 5 is the vertical digit and 0\nis the horizontal one, without the need for a comma.")
        print("")
        print("On each board, there are six ships – one that is 5 units long,\none that is 4 units long, two that are 3 units long, and finally,\ntwo that are 2 units long. Their placement can either be up and down (vertically)\nor side to side (horizontally).")
        print("")
